...
export function SharkHero({ compact = false }: { compact?: boolean }) {
  ...
  return (
    <div className={`relative mx-auto flex w-full max-w-[380px] items-center justify-center [perspective:1000px] select-none pointer-events-none origin-center ${compact ? "h-[240px] scale-100" : "h-[190px] sm:h-[270px] scale-[0.78] sm:scale-100"}`}>
