  ...
  return (
    <div className="space-y-8 max-w-7xl mx-auto px-1 animate-fade-in text-zinc-900 dark:text-zinc-100">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        {/* Total Emprestado — clicável → lista de empréstimos */}
        <Link href="/emprestimos" className="col-span-1 relative overflow-hidden bg-white dark:bg-slate-900/60 card-accent border border-zinc-200 dark:border-white/8 rounded-2xl p-5 shadow-sm hover:shadow-md transition-all group cursor-pointer active:scale-[0.98]">
          ...
          <div className="mt-2 text-sm text-zinc-400 flex items-center gap-1">
        ...
        {/* Total a Receber — clicável → lista de empréstimos */}
        <Link href="/emprestimos" className="col-span-1 relative overflow-hidden bg-white dark:bg-slate-900/60 border border-emerald-200 dark:border-emerald-500/20 rounded-2xl p-5 shadow-sm hover:shadow-emerald-500/10 hover:shadow-lg transition-all group cursor-pointer active:scale-[0.98]">
          <div className="flex items-center justify-between mb-4">
        ...
        {/* Atrasados — clicável → painel de cobranças */}
        <Link href="/cobrancas" className="col-span-1 relative overflow-hidden bg-white dark:bg-slate-900/60 border border-rose-200 dark:border-rose-500/20 rounded-2xl p-5 shadow-sm hover:shadow-rose-500/10 hover:shadow-lg transition-all group cursor-pointer active:scale-[0.98]">
          <div className="flex items-center justify-between mb-4">
        ...
        {/* Vencendo Hoje — clicável → painel de cobranças */}
        <Link href="/cobrancas" className="col-span-1 relative overflow-hidden bg-white dark:bg-slate-900/60 border border-amber-200 dark:border-amber-500/20 rounded-2xl p-5 shadow-sm hover:shadow-amber-500/10 hover:shadow-lg transition-all group cursor-pointer active:scale-[0.98]">
          <div className="flex items-center justify-between mb-4">
